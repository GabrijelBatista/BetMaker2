        ...
        >
            ...
            <v-card id="dialog_box2">
                <v-card-title class="card_title justify-center">
                    ...
                    <v-card-text  dark class="d-flex justify-center card_text" dark cols="12" sm="6">
...
export default{
    ...
    methods: {
        ...
        canvas_to_download(res){
            ...
            this.canvas2.width=res.width;
            this.canvas2.height=res.height;
            ...
            background_image2.onload = function(){
                ...
                if(match2!=null){
                    ...
                    if(home_team_name_width2.width>128*scale_properly){
                        ...
                        while(ctx2.measureText(array1[0]).width>128*scale_properly || ctx2.measureText(array1[1]).width>128*scale_properly){
                            font_size2--;
